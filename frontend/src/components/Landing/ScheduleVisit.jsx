...
const ScheduleVisit = () => {
  return (
    <>
        {/* <!--============================== Contact Area ==============================--> */}
        <div className="space overflow-hidden bg-theme position-relative award-area-1 pb-0 pt-5" 
        style={{backgroundImage: `url(assets/img/bg/award-bg-1-1.png)`}}>
            <div style={{width:'100%',background: 'linear-gradient(to bottom, transparent 50%, white 50%)'}}>
                <div className="overflow-hidden contact-area-4 z-index-common" data-sec-pos="top-half" data-pos-for=".award-area-1" id="contact-sec">
